  ...
  return (
    ...
    >
      ...
      <div className="adhkar_box mb-3 p-5 bg-[#2c2c2c] w-100 h-100 rounded-2xl flex flex-col items-center justify-center gap-3">
        ...
        <div className="content w-full h-full p-6 bg-[#525252] flex items-center justify-center text-center rounded-2xl">
      ...
      <div className="controls w-30 flex items-center justify-between">
        <ChevronLeft
          size={50}
